                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="file" id="profile_image" name="profile_image" value="{{ $editData->username }}">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg" id="image_preview" src="{{ url('upload/admin_images/'.$editData->profile_image) }}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
