                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="{{ route('blog.details', $oneBlog->id) }}"><img src="{{ asset($oneBlog->blog_image)}}" alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{ route('blog.details', $oneBlog->id) }}">{{ $oneBlog->blog_title }}</a></h5>
                                        <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($oneBlog->created_at)->diffForHumans() }}</span>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
